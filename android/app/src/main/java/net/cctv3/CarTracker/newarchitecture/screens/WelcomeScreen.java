package net.cctv3.CarTracker.newarchitecture.screens;
...
import net.cctv3.CarTracker.MainActivity;
import net.cctv3.CarTracker.R;
import net.cctv3.CarTracker.newarchitecture.cache.SharedPreferenceUtils;
